...
namespace StokTakipSistemi
{
    public partial class Giris : Form
    {
        ...
        {
            bool isLoginSuccess = new AuthenticationController().login(new UserModel(txtBoxKAdi.Text, txtBoxSifre.Text));
            // Debug.Write(isLoginSuccess.ToString());
